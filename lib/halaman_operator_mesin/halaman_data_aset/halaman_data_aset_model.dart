...
import 'halaman_data_aset_widget.dart' show HalamanDataAsetWidget;
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:infinite_scroll_pagination/infinite_scroll_pagination.dart';
import 'package:provider/provider.dart';

class HalamanDataAsetModel extends FlutterFlowModel<HalamanDataAsetWidget> {
    ...
    return controller
      ..addPageRequestListener(
        (nextPageMarker) => queryTbAsetRecordPage(
          queryBuilder: (_) => listViewDataAsetPagingQuery ??= query,
