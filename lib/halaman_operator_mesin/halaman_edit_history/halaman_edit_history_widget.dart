...
import 'halaman_edit_history_model.dart';
export 'halaman_edit_history_model.dart';

class HalamanEditHistoryWidget extends StatefulWidget {
  const HalamanEditHistoryWidget({
    super.key,
    required this.editHistory,
  });

  final DocumentReference? editHistory;

  @override
  State<HalamanEditHistoryWidget> createState() =>
      _HalamanEditHistoryWidgetState();
}

class _HalamanEditHistoryWidgetState extends State<HalamanEditHistoryWidget> {
  late HalamanEditHistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HalamanEditHistoryModel());

    _model.textFieldNamaAsetFocusNode ??= FocusNode();

    _model.merekTextFieldFocusNode ??= FocusNode();

    _model.textFieldStatusFocusNode ??= FocusNode();

    _model.textFieldKeteranganFocusNode ??= FocusNode();

    _model.tindakanTextFieldFocusNode ??= FocusNode();
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: StreamBuilder<TbHistoryRecord>(
                    stream: TbHistoryRecord.getDocument(widget!.editHistory!),
                    builder: (context, snapshot) {
                      ...
                      final inputDataContainerTbHistoryRecord = snapshot.data!;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                TextFormField(
                                  controller:
                                    ...
                                    text: valueOrDefault<String>(
                                      inputDataContainerTbHistoryRecord.nama,
                                      'N/A',
                                    ),
                                  ),
                                ...
                                TextFormField(
                                  controller:
                                      _model.merekTextFieldTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      inputDataContainerTbHistoryRecord.merek,
                                      'N/A',
                                    ),
                                  ),
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      controller: _model
                                        ...
                                        _model.dropDownPilihRuanganValue ??=
                                            inputDataContainerTbHistoryRecord
                                                .ruangan,
                                      ),
                                      options:
                                          dropDownPilihRuanganTbRuanganRecordList
                                ...
                                TextFormField(
                                  controller:
                                      _model.textFieldStatusTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      inputDataContainerTbHistoryRecord.status,
                                      'N/A',
                                    ),
                                  ),
                                  focusNode: _model.textFieldStatusFocusNode,
                                  autofocus: false,
                                  textInputAction: TextInputAction.next,
                                  readOnly: true,
                                  obscureText: false,
                                ...
                                TextFormField(
                                  ...
                                  focusNode:
                                      _model.textFieldKeteranganFocusNode,
                                  onChanged: (_) => EasyDebounce.debounce(
                                ...
                                TextFormField(
                                  controller:
                                      _model.tindakanTextFieldTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      inputDataContainerTbHistoryRecord
                                          .tindakan,
                                  ...
                                  focusNode: _model.tindakanTextFieldFocusNode,
                                  onChanged: (_) => EasyDebounce.debounce(
                                    '_model.tindakanTextFieldTextController',
                                    Duration(milliseconds: 2000),
                                    () => setState(() {}),
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    fillColor: FlutterFlowTheme.of(context)
                                        .secondaryBackground,
                                    suffixIcon: _model
                                            .tindakanTextFieldTextController!
                                            .text
                                            .isNotEmpty
                                        ? InkWell(
                                            onTap: () async {
                ...
                Row(
                  ...
                  children: [
                    FFButtonWidget(
                      onPressed: ((_model.textFieldNamaAsetTextController
                                          .text ==
                                      null ||
                              ...
                              (_model.textFieldKeteranganTextController.text ==
                                  ...
                                  _model.textFieldKeteranganTextController
                                          .text ==
                                      '') ||
                              (_model.tindakanTextFieldTextController.text ==
                                      null ||
                                  _model.tindakanTextFieldTextController.text ==
                                      ''))
                          ? null
                          : () async {
                              await widget!.editHistory!
                                  .update(createTbHistoryRecordData(
                                nama:
                                    _model.textFieldNamaAsetTextController.text,
