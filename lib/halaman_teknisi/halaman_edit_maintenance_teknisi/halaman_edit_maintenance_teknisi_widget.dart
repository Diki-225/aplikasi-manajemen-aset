...
import 'halaman_edit_maintenance_teknisi_model.dart';
export 'halaman_edit_maintenance_teknisi_model.dart';

class HalamanEditMaintenanceTeknisiWidget extends StatefulWidget {
  const HalamanEditMaintenanceTeknisiWidget({
    super.key,
  ...
  @override
  State<HalamanEditMaintenanceTeknisiWidget> createState() =>
      _HalamanEditMaintenanceTeknisiWidgetState();
}

class _HalamanEditMaintenanceTeknisiWidgetState
    extends State<HalamanEditMaintenanceTeknisiWidget> {
  late HalamanEditMaintenanceTeknisiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HalamanEditMaintenanceTeknisiModel());

    _model.textFieldNamaAsetFocusNode ??= FocusNode();

    _model.merekTextFieldFocusNode ??= FocusNode();

    _model.ruanganTextFieldFocusNode ??= FocusNode();

    _model.textFieldKategoriFocusNode ??= FocusNode();
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                TextFormField(
                                  controller:
                                    ...
                                    text: valueOrDefault<String>(
                                      containerTbMaintenanceRecord.namaAset,
                                      'N/A',
                                    ),
                                  ),
                                ...
                                TextFormField(
                                  controller:
                                      _model.merekTextFieldTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      containerTbMaintenanceRecord.merek,
                                      'N/A',
                                    ),
                                  ),
                                ...
                                TextFormField(
                                  controller:
                                      _model.ruanganTextFieldTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                  ...
                                  focusNode: _model.ruanganTextFieldFocusNode,
                                  autofocus: false,
                                  textInputAction: TextInputAction.done,
                                  readOnly: true,
                                  obscureText: false,
                                ...
                                TextFormField(
                                  controller:
                                      _model.textFieldKategoriTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                  ...
                                  focusNode: _model.textFieldKategoriFocusNode,
                                  autofocus: false,
                                  textInputAction: TextInputAction.done,
                                  readOnly: true,
                                  obscureText: false,
                                ...
                                TextFormField(
                                  controller: _model
                                      ...
                                      TextEditingController(
                                    text: valueOrDefault<String>(
                                      containerTbMaintenanceRecord.keterangan,
                                      'N/A',
                                    ),
                                  ),
                                  focusNode:
                                      _model.keteranganTextFieldFocusNode,
                                  autofocus: false,
                                  textInputAction: TextInputAction.done,
                                  readOnly: true,
                                  obscureText: false,
                                ...
                                TextFormField(
                                  controller:
                                      _model.textFieldTindakanTextController ??=
                                          TextEditingController(
                                    text: valueOrDefault<String>(
                                      containerTbMaintenanceRecord.tindakan,
                                      'N/A',
                                    ),
                                  ),
                  ...
                  FFButtonWidget(
                    onPressed: ((_model.dropDownPilihStatusValue == null ||
                                _model.dropDownPilihStatusValue == '') ||
                            ...
                            if (_model.dropDownPilihStatusValue == 'Baik') {
                              await TbHistoryRecord.collection
                                  ...
                                  .set(createTbHistoryRecordData(
                                    ...
                                    ruangan: _model
                                        .ruanganTextFieldTextController.text,
                                    kategori: _model
                                        .textFieldKategoriTextController.text,
                              ...
                              context
                                  .goNamed('halaman_tab_maintenance_teknisi');
                            }
                            await showDialog(
                              context: context,
